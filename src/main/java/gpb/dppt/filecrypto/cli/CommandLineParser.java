package gpb.dppt.filecrypto.cli;
...
public final class CommandLineParser {
    ...
    public static void printUsage() {
        ...
        builder.append("Usage:\n")
                .append("  java -jar gpb-file-crypto-service.jar ")
                ...
                .append("Examples:\n")
                .append("  java -jar gpb-file-crypto-service.jar -action encrypt -mode default -in /data/report.txt\n")
                .append("  java -jar gpb-file-crypto-service.jar -action decrypt -in /data/report.txt.enc -out /data/report.txt\n")
                .append("  java -jar gpb-file-crypto-service.jar -action encrypt -mode daemon -in /data/inbox -out /data/outbox -conf /opt/app/application.properties\n");
